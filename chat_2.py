...
class Chat:
	def __init__(self):
		...
		self.users['andrian']={ 'nama': 'Andrian A', 'negara': 'Indonesia', 'password': 'surabaya', 'incoming' : {}, 'outgoing': {}}
		self.users['hilmi']={ 'nama': 'Hilmi H', 'negara': 'Indonesia', 'password': 'surabaya', 'incoming': {}, 'outgoing': {}}
		self.users['rahel']={ 'nama': 'Rahel R', 'negara': 'Indonesia', 'password': 'surabaya','incoming': {}, 'outgoing':{}}
